  ...
  return (
    <CustomBackground>
      <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center" onClick={handleTap}>
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-white">Yay! Happy Valentine's Day Bon Bon! ❤️</h1>
        <p className="text-xl text-pink-200 mb-8">
          Awwww you said yes??? I don't believe it!! text me saying "YAY! Happy VDAY" if you've reached this stage.
        </p>

        <p className="text-xl mb-4 text-pink-200">TAP TAP TAP! FOR FINAL SURPRISE</p>
